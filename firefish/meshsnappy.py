...
class SnappyHexMesh(object):
	...
	def __init__(self, geom, surfaceRefinement, case):
		...
		self.relativeSizes = False
		self.nSurfaceLayers = 4
		self.expansionRatio = 1.2
		self.finalLayerThickness = 0.0003
		self.minThickness = 0.0001
		self.nGrow = 1
